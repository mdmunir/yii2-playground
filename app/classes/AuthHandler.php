...
class AuthHandler
{
    ...
    protected function getUser()
    {
        ...
        if ($identity) {
            return $identity instanceof Device ? $identity->user : $identity;
        }
    }
    ...
    protected function login($identity)
    {
        ...
        if ($user->identityClass == Device::className()) {
            $user->getIdentity()->link('user', $identity);
        } else {
    ...
    private function updateUserInfo(User $user)
    {
        ...
        if (UserContact::findOne(['user_id' => $user->id, 'type' => 'profile', 'name' => $this->clientId]) === null) {
